...
class _MyAppState extends State<MyApp> {
  List<Persona> _personas = [
    Persona('Nepomuceno', 'Martinez', '999999999'),
    Persona('Jose', 'Guerra', '987654321'),
    Persona('Maria', 'Arboleya', '112233123'),
    Persona('Pedro', 'Parques', '123456789'),
    Persona('Luis', 'Garza', '654123987'),
  ];

  void _agregarPersona() {
    setState(() {
      _personas.add(Persona('Marcky', 'Marck', '484848489'));
    });
  }
